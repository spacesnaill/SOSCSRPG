...
namespace Engine.Factories
{
     internal static class WorldFactory
     {
          internal static World CreateWorld()
          {
               ...
               newWorld.LocationAt(-2, -1).AddMonster(2, 100); //add rat to farmer's field
               ...
               newWorld.LocationAt(2, 0).AddMonster(3, 100); //add spider to spider forest
               ...
               newWorld.AddLocation(0, 2, "Herbalist's Garden",
                    "There are many plants, with snakes hiding behind them.",
                    "/Engine;component/Images/Locations/HerbalistsGarden.png");

               newWorld.LocationAt(0, 2).AddMonster(1, 100); //add snake to herbalist's garden
